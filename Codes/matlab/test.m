...
alpha=0.3; tt1=0.9*pi; tt2=0.1*pi;
...
a = a1*c4 + a4*c1 - a2*c3 - a3*c2 - lam*(a1 + a4 - a2 - a3);
b = a1*b4 + a4*b1 - a2*b3 - a3*b2 - lam*(c1 + c4 - c2 - c3);
c = b1*c4 + b4*c1 - b2*b3 - b3*c2 - lam*(b1 + b4 - b2 - b3);   
